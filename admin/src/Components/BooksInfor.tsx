          ...
          <div className="p-8 space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-900 font-semibold">{book.author}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-500 font-medium mb-1">Publication Year</p>
                <p className="text-lg text-gray-900 font-semibold">{book.year}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-900 font-semibold">{book.genre}</p>
              </div>
            </div>
